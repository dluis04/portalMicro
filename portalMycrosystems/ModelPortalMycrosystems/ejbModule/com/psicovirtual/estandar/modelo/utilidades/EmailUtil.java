...
public class EmailUtil {
	...
	public static void enviarMailSimple(String[] destinatarios, String asunto,
		...
		email.setAuthenticator(new DefaultAuthenticator(
				"psicovirtual1@gmail.com", "Hostinger2017"));
		email.setSSLOnConnect(true);
		email.setFrom("psicovirtual1@gmail.com");
	...
	public static void enviarMailHTML(List<String> destinatarios, String asunto,
		...
		email.setSmtpPort(465);
		email.setAuthentication("psicovirtual1@gmail.com", "Hostinger2017");
		email.setSSLOnConnect(true);
	...
	public static void main(String[] args)  throws Exception{
		...
		rem.add("johnpantoja21@gmail.com");
		...
		System.out.println("termino" + anio );
